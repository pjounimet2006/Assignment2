    ...
    public partial class StockList
    {
        ...
        public void SortByName()
        {
           ...
           StockNode current = this.head;
            ...
            while (this.SortCheck() != 0) // Procedure That Checks if List is in Alphabetical Order
            {                             //Keeps looping until List in order   
                this.Sort(); // IF not In order, invokes method to Order the List
            }

        }//
        public void Sort()

        { // Procedure that executes one Run curr/next comparisson to apply alphabetical order
...

            {
                ...
                if (current.Next != null)
                {
                    ...
                    {
                        //Utililizes Swap Metho for Changing position within list pushing it back
        ...
        public int SortCheck()

        { // Procedure that checks alphabetical order. If>1, is not in Order
            int count;
        ...
        { // Procedure that executes one Run curr/next comparisson to apply descending holdings order
        ...
        public int SortCheckValue()

        { // Procedure that checks descending holdings order. If>1, is not in Order
            int count;
